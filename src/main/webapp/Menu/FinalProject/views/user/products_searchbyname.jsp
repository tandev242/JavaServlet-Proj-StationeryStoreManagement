            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="span9">
                        ...
                        <h3> <small class="pull-right"> ${listPro.size()} sản phẩm được tìm thấy</small></h3>	
                        <hr class="soft"/>
                        <h3 style="color: violet ; font-family: sans-serif ; text-align: center"> CHÂM NGÔN BÁN HÀNG </h3>
                        <p style="color: #0000FF ; text-align: center">
                            Bán hàng thành công đến sau khi bạn vươn mình ra khỏi những giới hạn cơ bản hằng ngày – Omar Periu. </br>
                            Lỗi lầm lớn nhất của chúng ta là nằm ở chịu thua. Cách tốt nhất trong số cách để thành công là thử thêm một lần nữa – Thomas Edison.
                        </p>
                        <hr class="soft"/>
                                    ...
                                    <div class="row">	  
                                        ...
                                        <div class="span3 alignR">
                                            <form class="form-horizontal qtyFrm">
                                                ...
                                                <a href="${pageContext.request.contextPath }/product/detail?id=${p.getID()}" class="btn btn-large btn-primary"> Thêm vào <i class=" icon-shopping-cart"></i></a>
                                                <a href="${pageContext.request.contextPath }/product/detail?id=${p.getID()}" class="btn btn-large"><i class="icon-zoom-in"></i></a>
                                    ...
                                    <c:forEach items="${listPro}" var="p">
                                        <li class="span3">
                                            <div class="thumbnail">
                                                ...
                                                <div class="caption">
                                                    <h5 style="height: 40px;">${p.getName()}</h5>
                                                    <input hidden="true" value="${p.getID()}"/>
                                                    <h4 style="text-align:center"><a class="btn" href="${pageContext.request.contextPath }/product/detail?id=${p.getID()}"> <i class="icon-zoom-in"></i></a> <a class="btn add-cart" href="javascript:void(0);">Thêm<i class="icon-shopping-cart"></i></a> <a class="btn btn-primary" href="#">${p.getPrice()} VND</a></h4>
                                                </div>
                                            </div>
                                        </li>
                                    </c:forEach>
