...
public class ConfigDAO {
    ...
    public static String vnp_Returnurl = "http://localhost:8080/ProjCK/pay";
    public static String vnp_TmnCode = "FJQFO2RR";
    public static String vnp_HashSecret = "HWHBGTEATYMMWBNVQSOBZXXBBUKQSVCN";
    ...
    public static String hashAllFields(Map fields) throws UnsupportedEncodingException {
        ...
        sb.append(ConfigDAO.vnp_HashSecret);
